...
import es.aaronquintanal.digiactivity.databinding.ActivityFieldAdapterBinding
import es.aaronquintanal.digiactivity.model.DigiFields
...
class FieldAdapter(private val fields: List<DigiFields>): RecyclerView.Adapter<FieldAdapter.FieldViewHolder>(){
    ...
    class FieldViewHolder(view: View): RecyclerView.ViewHolder(view){
        private val binding = ActivityFieldAdapterBinding.bind(view)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FieldViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(R.layout.activity_field_adapter, parent, false)

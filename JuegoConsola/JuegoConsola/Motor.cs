...
namespace JuegoConsola
{
    public class Motor
    {
        ...
        {
            this.granizo = new Granizo(resolucionX, resolucionY);
            this.queco = new Queco(resolucionX);
            this.velocidad = 1000;
            this.reloj.Elapsed += new ElapsedEventHandler(reloj_Elapsed);
        }
       ...
       /// <remarks>
        ...
        public int BolasPorLinea
        {
            get
            {
                return BolasPorLinea;
            }
            set
            {
                this.BolasPorLinea = value;
                Parar();
                this.granizo.BolasPorLinea = value;
            }
        }
        ...
        private void Dibujar()
        {
            ...
            Console.Clear();
            Console.WriteLine(granizo.Estado);
            Console.WriteLine(queco.Posicion);
        ...
        {
            if(granizo.Estado[0, queco.Posicion] == 0)
            {
                return true;
            }
            return false;

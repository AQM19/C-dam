...
import es.aaronquintanal.app_ut2_06.databinding.FragmentPersonasBinding
...
class FragmentPersonas : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.numberPickerAdultos.apply {
            ...
            setOnValueChangedListener{_,_,nuevo -> viewModelCompartido.setNumeroAdultos(nuevo)}
        }
        ...
        binding.numberPickerNinos.apply {
            ...
            value = 0
            wrapSelectorWheel = false
            setOnValueChangedListener{_,_,nuevo -> viewModelCompartido.setNumeroNinos(nuevo)}
        }

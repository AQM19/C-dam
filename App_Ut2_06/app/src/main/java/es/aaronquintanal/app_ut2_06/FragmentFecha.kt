...
import es.aaronquintanal.app_ut2_06.databinding.FragmentFechaBinding
import java.util.*
...
class FragmentFecha : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.datePicker.init(hoy.get(Calendar.YEAR), hoy.get(Calendar.MONTH), hoy.get(Calendar.DAY_OF_MONTH)) { _, year, month, day ->

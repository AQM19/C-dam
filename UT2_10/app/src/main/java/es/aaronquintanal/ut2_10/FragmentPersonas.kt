package es.aaronquintanal.ut2_10
...
class FragmentPersonas : Fragment() {
    ...
    private lateinit var binding: es.aaronquintanal.ut2_10.databinding.FragmentPersonasBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = es.aaronquintanal.ut2_10.databinding.FragmentPersonasBinding
